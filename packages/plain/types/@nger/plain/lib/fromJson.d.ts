...
export declare function hasPlainDesc(it: any, val: any): boolean;
export declare function getPlainPros(type: any): IPropertyDecorator<any, PlainPro>[];
export declare function getPlainDesc(type: any): string | number | (string | number)[] | undefined;
export declare function toPlain(instance: any, key?: string, handler?: (source: any, target: any) => any): any;
